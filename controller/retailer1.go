...
// @Success 200 {object} middleware.Response{data=dao.ProductInfo} "success"
// @Router /retailer1/search/product/{keyword} [get]
func (r *Retailer1Controller) SearchProductInfoByName(c *gin.Context) {
...
// @Success 200 {object} middleware.Response{data=string} "success"
// @Router /retailer1/order [post]
func (r *Retailer1Controller) CreateOrder(c *gin.Context) {
	...
	orderInput.Collection = fabsdk.CollectionTransaction1
